...
export const steps: Step[] = [
  {
    ...
    body: "Pick a live drop like #SummerVibes or #CampusVibes. Free to enter, backed by a real BNB prize pool on BNB Chain.",
    tag: "Free to enter",
  },
  {
    icon: Camera,
  ...
  },
  {
    ...
    body: "Everyone backs their favorite snaps with one-tap free votes. The most-loved moments rise to the top.",
    tag: "$0 gas, sponsored",
  },
  {
    icon: Coins,
